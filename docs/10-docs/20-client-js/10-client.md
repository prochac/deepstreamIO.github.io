...
|options|Object|true|A map of options. Please find a list of available options [here](20-options.md)
...
### getConnectionState()
Returns the current connectionState. Please find a list of available connectionStates [here](/docs/tutorials/concepts/connectivity#connection-states).
