...
If you need to check your credentials or retrieve a token from the authentication server use the `authPath` defined on the [http server config](../server/configuration#http)
